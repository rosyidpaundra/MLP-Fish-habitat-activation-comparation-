...
class PrediksiIkanMLPReLU(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        ...
        self.addParameter(QgsProcessingParameterRasterDestination(self.OUTPUT, 'Hasil Prediksi MLP ReLU'))

    def processAlgorithm(self, parameters, context, feedback):
        np.random.seed(42)

        feedback.pushInfo("==================================================")
        feedback.pushInfo("  MODEL: MLP | AKTIVASI: ReLU | Alpha: 5.0")
        feedback.pushInfo("  Arsitektur: 1 Hidden Layer, 3 Neuron, L-BFGS")
        ...
        feedback.pushInfo("======== HASIL EVALUASI MODEL - AKTIVASI ReLU ========")
    ...
    def name(self): return 'mlp_relu'
    def displayName(self): return 'MLP Fishing Ground - ReLU Activation by Rosyid Paundra'
    def group(self): return 'Perikanan'
    def groupId(self): return 'perikanan'
    def createInstance(self): return PrediksiIkanMLPReLU()
